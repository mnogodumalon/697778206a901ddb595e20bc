        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Welche Gewohnheiten hast du heute ausgeführt?</TableHead>
          ...
          <TableBody>
            {filtered.map(record => (
              <TableRow key={record.record_id} className="hover:bg-muted/50 transition-colors">
                ...
                <TableCell>{getGewohnheitenVerwaltungDisplayName(record.fields.gewohnheiten)}</TableCell>
                <TableCell>{record.fields.zeit_investiert ?? '—'}</TableCell>
                <TableCell>
